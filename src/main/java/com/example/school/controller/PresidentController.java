...
public class PresidentController {
    ...
    public Set<Teacher> getSchoolTeachers(@PathVariable("presidentId") int presidentId){
    ...
    public Set<Student> getSchoolStudents(@PathVariable("presidentId") int presidentId){
